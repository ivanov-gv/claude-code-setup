...
Approximate content of the guidelines folder:

- shared/guidelines/code/general/coding.md
- shared/guidelines/code/general/optimisation.md
- shared/guidelines/code/general/review.md
- shared/guidelines/code/general/testing.md
- shared/guidelines/code/golang/build-and-deploy.md
- shared/guidelines/code/golang/conventions.md
- shared/guidelines/code/golang/optimisation.md
- shared/guidelines/code/golang/testing.md
- shared/guidelines/code/python/python-specific-conventions.md
